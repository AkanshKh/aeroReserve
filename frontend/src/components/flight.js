                                        ...
                                        <div className="each-flight-div" onClick={() => handleBook(flight)}>
                                            <div className="flight-company">
                                                ...
                                                <div className="company-details">
                                                    <div className="company-name">{flight.company}</div>
                                                    <div className="plane-name">{flight.code}</div>
                                                </div>
                                            </div>
                                            <div className="flight-time flight-time-div">
                                                <div className="flight-origin-time">
                                                    ...
                                                    <div className="flight-place">{flight.from}</div>
                                                </div>
                                                <div className="flight-stops tooltip">
                                                    ...
                                                    <span className="tooltiptext">{flight.duration}</span>
                                                </div>
                                                <div className="flight-destination-time">
                                                    <div className="flight-time">
                                                        <h5>{flight.arrivalTime}</h5>
                                                    </div>
                                                    <div className="flight-place">{flight.to}</div>
                                                </div>
                                            </div>
